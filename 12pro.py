...
gye = LINE('EvL8aV6MMOnPS5pTjMv3.pCzBAzC2ple8azqAffLbaW.8LPxFqk2CNTuUmMzh/7jWhCILhJzVbOHhFTTBP5GREc=')
gye.log("Auth Token : " + str(gye.authToken))
channelToken = gye.getChannelResult()
gye.log("Channel Token : " + str(channelToken))

ais = LINE('Ev3xYP24Rx3y0DXKSJv1.+Dglr5AFXp3LSOAlKXMbKq.WO1FkwUBjZFC1D2jydsqEz7XEbzajZbzTyZm//4Mg1I=')
ais.log("Auth Token : " + str(ais.authToken))
channelToken = ais.getChannelResult()
ais.log("Channel Token : " + str(channelToken))

ki2 = LINE('EvPm2ZTbqYvZgxoVUhK8.HLVcXY9UB18uhycEdATEwa.AgZ5wx7Z8vtinqwn5eZ7hRfpxgwKEGkbGPVGXmLgDtc=')
ki2.log("Auth Token : " + str(ki2.authToken))
channelToken = ki2.getChannelResult()
ki2.log("Channel Token : " + str(channelToken))

ki3 = LINE('Evx91TU6Byy9y4BnPmj0.NTqIcMXpvJXYXd3N+GFgWa.8Nc4V2tPSbH2dZeC7/OBJ1CzI4Q2IBAYzU7Qc58yLaE=')
ki3.log("Auth Token : " + str(ki3.authToken))
channelToken = ki3.getChannelResult()
ki3.log("Channel Token : " + str(channelToken))

ki4 = LINE('EvawrSAsrqWWY7tTBmy3.MhmKIKWfe0kkBm+WO17q0W.ahMJxX9y8/gZasNSul5H6tgPLnmE0fEtFh3vwo2MLbk=')
ki4.log("Auth Token : " + str(gye.authToken))
channelToken = ki4.getChannelResult()
ki4.log("Channel Token : " + str(channelToken))

ki5 = LINE('Ev3x2CCxBqGnKj7NrEE8.H0qWlLfU21CpPzslJtbJQa.rH/9Qc6mCJE0pGZsXlTZi4IK5s1UJu94opzUIUe5u0Q=')
ki5.log("Auth Token : " + str(gye.authToken))
channelToken = ki5.getChannelResult()
ki5.log("Channel Token : " + str(channelToken))

ki6 = LINE('EvjWdly46lXAPYo38Dea.LhW7Jy0E3dSQXyZp//eIEG./PC+PYowZBQSn8AZ/UqPU0QGDGWU6ZcmpLoldd6R5bI=')
ki6.log("Auth Token : " + str(gye.authToken))
channelToken = ki6.getChannelResult()
ki6.log("Channel Token : " + str(channelToken))

ki7 = LINE('EvJl3PWKCh0bVsmNEYF4.lsuliQbRFyFn/N6v3aOBfa.ZxMPfPvnhRDvRMPvNcFgmwRzB77eBq2jg0yaZkrl8S0=')
ki7.log("Auth Token : " + str(gye.authToken))
channelToken = ki7.getChannelResult()
ki7.log("Channel Token : " + str(channelToken))

ki8 = LINE('Ev7DyCccgnlEyBPcOHya.nXyLJukcsbFE7pqvirFxAG.bqyVHQCVhMdwBY9KJV/8wWG4DMiO+k47pj4mgZkL4aU=')
ki8.log("Auth Token : " + str(gye.authToken))
channelToken = ki8.getChannelResult()
ki8.log("Channel Token : " + str(channelToken))

ki9 = LINE('Ev1EnTr4MSoPUnmny5Ae.sFA3qpOMx93TzMuUgdpjZG.wPPCQ0Pg55wfOomFJJ/Q1e8xWExPQ0Wjgkn9phlK94g=')
ki9.log("Auth Token : " + str(gye.authToken))
channelToken = ki9.getChannelResult()
ki9.log("Channel Token : " + str(channelToken))

ki10 = LINE('EvdWtrOT69zBDLnQNWZe.NXBzQSs27AbcX+4QQsMMZG.QIj77A9hZA0uHFmqA0s0lmvgNa/LToh+99O6PAZZoV4=')
ki10.log("Auth Token : " + str(gye.authToken))
channelToken = ki10.getChannelResult()
ki10.log("Channel Token : " + str(channelToken))

ki11 = LINE('Evwki3cTCVt3K3DgsRK0.uBPYqXPWza/mmc0eBvTvea.zT5F7SOlMgJl7pWh8isuq7/kCFzQvtox+77ZsZ8a9cY=')
ki11.log("Auth Token : " + str(gye.authToken))
channelToken = ki11.getChannelResult()
ki11.log("Channel Token : " + str(channelToken))

ki12 = LINE('EvHNLpvmTSmHb4kjiQxc.son4RuzI7/lhHSwkJZgo+a.hNYXLWHSccu5zfjnrY3QwL3lnNLeDpgJ8dv3yiagxYY=')
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    gye.sendContact(to, "u3dc65b6997363cb13c01941a14594103")
                elif text.lower() == 'proset':
                    helpTextToSpeech = helptexttospeech()
                    gye.sendMessage(to, str(helpTextToSpeech))
                elif text.lower() == 'medias':
                    helpTranslate = helptranslate()
                    gye.sendMessage(to, str(helpTranslate))
#==============================================================================#
                elif text.lower() == 'run':
                    start = time.time()
                    gye.sendMessage(to, "Writing....")
...
#-------------------------------------------------------------------------------
                        ...
                        if Owner == []:
                            ...
                            gye.sendMessage(msg.to,mc + "╠═══════════════\n╠〘 line.me/ti/p/~who.i.am.〙\n╚═══════════════")
#-------------------------------------------------------------------------------
                elif msg.text.lower().startswith("adminad "):
                        targets = []
                        key = eval(msg.contentMetadata["MENTION"])
                        key["MENTIONEES"][0]["M"]
                        for x in key["MENTIONEES"]:
...
#-------------------------------------------------------------------------------
                        ...
                        if settings["protect"] == True:
                            if settings["lang"] == "JP":
                                gye.sendMessage(msg.to,"Protection On")
                        else:
                        ...
                        if settings["protect"] == False:
                            if settings["lang"] == "JP":
                                gye.sendMessage(msg.to,"Protection Off")
                        else:
                            settings["protect"] = False
                            if settings["lang"] == "JP":
                                gye.sendMessage(msg.to," Protection Set To Off")
#----------------------------------------------------------------------------------------                        
                elif text.lower() == 'qrpro on':
...
#-------------------------------------------------------------------------------
                        ...
                        gye.sendMessage(msg.to,"Ke pro an lu mek!")
             ...
             #       if msg._from in Owner:
                        ...
                        settings["inviteprotect"] = False
                        settings["cancelprotect"] = False
                        gye.sendMessage(msg.to,"Nuub kok ngaku pro?")
            #        else:
...
#=======================================================================================
                elif msg.text.lower().startswith("ks "):
                       targets = []
                       key = eval(msg.contentMetadata["MENTION"])
                       key["MENTIONEES"][0]["M"]
                       for x in key["MENTIONEES"]:
...
#==========                      
                    ...
                    if op.param2 in admin:
                        ...
                        random.choice(KAC).sendText(op.param1,"Hayo kak tanganya kondisikan..!")
